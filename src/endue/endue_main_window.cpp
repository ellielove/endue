...
void MainWindow::create_actions()
{
    ...
    connect(autosave_document_action, &QAction::triggered, this, &MainWindow::on_triggered__auto_save_document);
    ...
    connect(copy_current_selection_action, &QAction::triggered, this, &MainWindow::on_triggered__copy_current_selection);
    ...
    connect(cut_current_selection_action, &QAction::triggered, this, &MainWindow::on_triggered__cut_current_selection);
    ...
    connect(exit_program_action, &QAction::triggered, this, &MainWindow::on_triggered__exit_program);
    ...
    connect(new_document_action, &QAction::triggered, this, &MainWindow::on_triggered__create_new_document);
    ...
    connect(open_document_action, &QAction::triggered, this, &MainWindow::on_triggered__open_existing_document);
    ...
    connect(paste_current_selection_action, &QAction::triggered, this, &MainWindow::on_triggered__paste_current_selection);
    ...
    connect(redo_action, &QAction::triggered, this, &MainWindow::on_triggered__redo_last_action);
    ...
    connect(save_as_document_action, &QAction::triggered, this, &MainWindow::on_triggered__save_document_as);
    ...
    connect(undo_action, &QAction::triggered, this, &MainWindow::on_triggered__undo_last_action);
}
...
void MainWindow::on_triggered__create_new_document()
{
...
void MainWindow::on_triggered__open_existing_document()
{
...
void MainWindow::on_triggered__save_document_as()
{
...
void MainWindow::on_triggered__auto_save_document(){qDebug()<<"auto_save_document";}
void MainWindow::on_triggered__exit_program(){qDebug()<<"exit_program";}
void MainWindow::on_triggered__undo_last_action(){qDebug()<<"undo_last_action";}
void MainWindow::on_triggered__redo_last_action(){qDebug()<<"redo_last_action";}
void MainWindow::on_triggered__cut_current_selection(){qDebug()<<"cut_current_selection";}
void MainWindow::on_triggered__copy_current_selection(){qDebug()<<"copy_current_selection";}
void MainWindow::on_triggered__paste_current_selection(){qDebug()<<"paste_current_selection";}
